...
& - \text{\color{red}{reflected solar radiatiuon}}\newline
...
The heat content of the Earth per unit area is given by $C T$, where $C$ is the heat capacity per unit area and $T$ the planet's temperature in Kelvin degrees. The heat capaciy is the amount of heat a body needs to absorb to increase its temperature by one degree Kelvin. We take $C$ to be the heat capacity of the top 500 meter of the ocean since 75% of the Earth is covered by oceans and heat is absorbed primarily in the upper 500 meters on decadal timescales: $C= 2 \times 10^9$ W/m$^2$ or $C= 63$ Wyr/m$^2$.
...
The energy emitted by a blackbody per unti time and unit area at wavel;ngth λ is given by the fomrula:
...
begin
	C = 63.; # atmosphere and upper-ocean heat capacity [Wyr/m^2/°C]
	σ = 5.670374419*10^(−8) # [W/m^2/K^4]
	temp₀ = 0 #absolute zero [K]
end

# ╔═╡ 7187ae25-239d-4752-898e-6674009b5de6
 p1 = ODEProblem( (temp, p, t)-> (1/C) * absorbed_solar_radiation, temp₀,  (0, 150) )
...
begin
	...
	annotate!( 100, 35+temp₀, text("Initial Temperature = $(temp₀) K",color=:white))
	title!("Absorbing Solar Radiation (only)")
end

# ╔═╡ 03ccad3d-09ed-4621-9845-ceb605072ebf
md"""
The Earth's temperature would reach 569 K = 842°C, above boiling point of water, after 150 years.
"""

# ╔═╡ 2b66ffaf-a9a3-4ca2-a6e9-732912c9d48e
md"""
---
#### 4) Outgoing thermal radiation without an atmosphere (longwave)
"""

# ╔═╡ d76af110-ae17-4e74-b0f9-870d05bedb87
md"""

In the absence of an atmosphere, the Earth's would behave as a perfcet blackbody in the infrared range. The inmocing solar radiation would be re-emitted as thermal radiation:
...
# ╔═╡ b12209a8-2f34-4daa-8288-d91339a940f9
 p2 = ODEProblem( (temp, p, t)-> (1/C) * (absorbed_solar_radiation-σ*temp^4), temp₀,  (0, 150) )
...
md"""
---
#### 5) Outgoing thermal radiation with an atmosphere (longwave)
"""

# ╔═╡ af893e1e-3bd7-4d05-83b6-f5f7e751b5e3
# md"""
# start\_temp = $(@bind temp₀ Slider(0:28; show_value=true, default=14))
# """
...
# ╔═╡ d94b858c-a340-473e-a17b-b4a5629a4c08
(absorbed_solar_radiation/σ)^(1/4)-273.15

# ╔═╡ 13b9a2de-d96a-44b0-8595-8cff2079276e


# ╔═╡ 137f249b-b9ca-4809-a595-01a50d2621fb


# ╔═╡ 8d727a11-9166-4a12-8a80-12536bc48c4c


# ╔═╡ 2590902c-3f3f-470c-b432-26a603ac5d1d


# ╔═╡ 9f0cb02a-f121-4287-b493-e3004ea3dd8e


# ╔═╡ 800e7407-9f2d-45d1-a928-7ff6d6789a1c


# ╔═╡ 6899723c-311c-421c-9790-587eb533f1f5


# ╔═╡ 739c7f28-0dbb-4dc0-bb8b-98043cb5db6f


# ╔═╡ 2ea9693b-3075-4e62-9879-77e336536f9b


# ╔═╡ b03a8912-43fb-43ea-9793-25e76757ce04


# ╔═╡ 27b296f2-bab1-41d3-aa6a-a2e91d8dd108


# ╔═╡ 18e164f5-0ad7-4920-9229-8603983a200b


# ╔═╡ b340f3b6-22c2-427d-8e3c-442c656112d0


# ╔═╡ d316a4b0-b47b-4b64-9a99-52b59537eff1
